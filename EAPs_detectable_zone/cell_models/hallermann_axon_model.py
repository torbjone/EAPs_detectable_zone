...
def return_constructed_myelinated_axon(dt, tstop, num_splits,
    ...
    sec_list = []
    set_additional_hallermann_params()
...
def return_constructed_unmyelinated_axon(dt, tstop, num_splits,
                                         split_angle_fraction,
                                         axon_diameter=0.3):
    import LFPy
    neuron.load_mechanisms(mechanisms_folder)
...
def return_constructed_combo_axon(dt, tstop, num_splits,
                                  split_angle_fraction,
                                  axon_diameter=0.3):
    import LFPy
    neuron.load_mechanisms(mechanisms_folder)
...
def return_constructed_unmyelinated_segment_axon(dt, tstop,
                                  axon_diameter=0.3):
    import LFPy
    neuron.load_mechanisms(mechanisms_folder)
    ...
    for i in range(40):
        ...
        start_pos = end_pos.copy()
        end_pos = start_pos + axon_axis * node_length
        sec_node, sec_type_counter = make_sec_from_dict("node",
                                                        sec_type_counter,
                                                        node_dict, start_pos,
                                                        end_pos)
    ...
    # Finish with myelinated part:
    for i in range(40):

        end_pos = start_pos + axon_axis * my_length
        sec_myelin, sec_type_counter = make_sec_from_dict("my",
                                                          sec_type_counter,
                                                          myelin_dict,
                                                          start_pos, end_pos)

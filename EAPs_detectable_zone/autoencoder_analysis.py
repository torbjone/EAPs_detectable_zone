...
if __name__ == '__main__':
    ...
    # ae_name = "vae-5"
    ae_name = "autoencoder-9"

    rec_filename = "%s_reconstructions.npy" % ae_name
    z_filename = "%s_z.npy" % ae_name
    ...
    fig_name = f"{ae_name}_latent_space.png"
    ...
    for waveform_idx in range(100):
        #waveform_idx = 54
        fig_name = f"{ae_name}_waveform_{waveform_idx}.png"
